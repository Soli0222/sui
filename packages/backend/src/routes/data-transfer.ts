...
const salaryRecordSchema = z.object({
  ...
  childcareSupportLevy: nonNegativeInt32Schema().default(0),
  incomeTax: nonNegativeInt32Schema(),
  residentTax: nonNegativeInt32Schema(),
  employeeStockContribution: nonNegativeInt32Schema().default(0),
  employeeStockIncentive: nonNegativeInt32Schema().default(0),
  dcMatchingContribution: nonNegativeInt32Schema().default(0),
