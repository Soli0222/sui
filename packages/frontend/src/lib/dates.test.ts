...
describe("addMonthsToYearMonth", () => {
  ...
  it("goes back by one month in normal and year-crossing cases", () => {
    expect(addMonthsToYearMonth("2026-02", -1)).toBe("2026-01");
    expect(addMonthsToYearMonth("2026-01", -1)).toBe("2025-12");
    expect(addMonthsToYearMonth("2024-03", -1)).toBe("2024-02");
  });
