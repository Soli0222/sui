...
export type DialogLayer = "standard" | "confirmation";
...
export function DialogContent({
  ...
  layer = "standard",
  ...props
}: PropsWithChildren<{ className?: string; size?: DialogSize; layer?: DialogLayer }> &
  Omit<ComponentProps<typeof DialogPrimitive.Content>, "className">) {
  return (
    <DialogPrimitive.Portal>
      <DialogPrimitive.Overlay className={cn(
        "dialog-overlay fixed inset-0 bg-black/70",
        layer === "confirmation" ? "z-[80]" : "z-[70]",
      )} />
