...
![Version: 0.6.0](https://img.shields.io/badge/Version-0.6.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.1.0-beta.4](https://img.shields.io/badge/AppVersion-2.1.0--beta.4-informational?style=flat-square)
...
| mcp.oauth.maxConcurrentRequests | string | `""` |  |
| mcp.oauth.maxRequestsPerMinute | string | `""` |  |
| mcp.oauth.resourceUrl | string | `""` |  |
| nameOverride | string | `""` |  |
| nodeSelector | object | `{}` |  |
